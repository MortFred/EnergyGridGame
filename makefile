...
src/obj/main.o: src/main.cpp include/HelloCpputest.h include/HelloSDL.h include/PowerPlants.h include/GameState.h include/GameLogic.h
...
game: src/obj/main.o src/obj/HelloSDL.o src/obj/PowerPlants.o
	$(CC) -o $@ $^ $(LINKER_FLAGS)
